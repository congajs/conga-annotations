...
var Reader = function(registry){
	...
	this.parseAttributeAnnotation = function(annotationsToFind, attribute){

		//console.log('PARSE ATTRIBUTE');
		//console.log(attribute);


		return __parseAnnotations(null, attribute, annotationsToFind)[0];
	};
