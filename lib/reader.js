...
var Reader = function (registry) {
   ...
   */
  const __parseConstructorAnnotations = function (className, target, comment, filePath) {
   ...
   * @param {String} filePath
   */
  const __parseDefinitionAnnotations = function (target, comment, filePath) {
   ...
   * @param {String} filePath
   */
  const __parseMethodAnnotations = function (className, target, comment, filePath) {
   ...
   * @param {String} filePath
   */
  const __parsePropertyAnnotations = function (className, target, comment, filePath) {
   ...
   * @returns {void}
   */
  const __createAnnotationMap = function () {
   ...
   * @returns {Array}
   */
  const __parseAnnotations = function (className, target, comment, annotationsToFind, filePath) {
